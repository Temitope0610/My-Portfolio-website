...
class AboutSection extends React.Component{
    render(){
        return(
            <div className='About-section frontend-about'>
                 <img src={Divide} className='dividing-icon fa-spinner mt-5' alt="dividing icon" />
                <div className='about-section' id='about'>
                    <Row>
                        ...
                        <Col sm='3'>
                            <h6>Tools</h6>
                            <p>Vscode, Sublime Text, Github</p>
                            <h6 className='mt-4'>Skills</h6>
                            <p>Html5</p>
                            <Progress percent={95} theme={{active:{
                                color: '#e97c35'
                            }}} />
                           <p>Css3</p>
