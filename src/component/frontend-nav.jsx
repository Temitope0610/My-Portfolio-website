...
import Logo from '../asset/images/my logo/logo temitope wht.png'
...
window.addEventListener('scroll', changeNav);
        ...
        return(
            <div div className={colorChange ? 'navbar frontend-nav colorChange' : 'navbar frontend-nav'}>
                    <img src={Logo} alt="my logo in white" className='logo mt-3' />
                    ...
                    <button className='contact-btn mt-3'><Link to='contact' spy={true} smooth={true}>Contact Me</Link></button>
               ...
               {/* mobile-nav */}
               <div ref={mobileNavMenu} className="frontend-nav mobile-nav d-md-none d-none animate__animated animate__fadeInRight">
